      ...
      <ul class="nav">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="emails">
            <ul class="nav sub-menu">
              <li class="nav-item">
                <a href="javascript:;" class="nav-link">All Type</a>
              </li>
              <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="Amenitie">
            <ul class="nav sub-menu">
              <li class="nav-item">
                <a href="javascript:;" class="nav-link">All Amenitie</a>
              </li>
              <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="advancedUI">
            <ul class="nav sub-menu">
              <li class="nav-item">
                <a href="javascript:;" class="nav-link">All Permission</a>
              </li>
              <li class="nav-item">
