...
<head>
    ...
    <!-- Toastr and SweetAlert2 Scripts -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 ps-md-0">
                                    <div class="auth-form-wrapper px-4 py-5">
                                        <a href="#" class="noble-ui-logo logo-light d-block mb-2">Nzaui SubCounty Offices<span></span></a>
                                        ...
                                        <form class="form-sample" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div>
                                                <a href="dantechdevs.html" class="d-block mt-3 text-muted">Developed By Dantechdevelopers call +254712328150<span></span></a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
