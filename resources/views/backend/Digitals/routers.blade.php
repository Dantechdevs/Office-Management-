                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('delete.digital', $device->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this router?');">Delete</button>
                        </form>
                    </td>
                </tr>
            @empty
                <tr>
                    <td colspan="13" class="text-center">No routers found.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
